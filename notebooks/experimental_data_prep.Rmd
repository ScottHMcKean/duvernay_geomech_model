...
We fit a model of Vp and Vs against confining and deviatoric stressfor each 
ultrasonic measurement 
```{r}
static_nest_no_res <- static_df %>% 
  select(-yield_stress_dev, -residual_stress_dev) %>%
...
This chunk merges the tests with or without residual stress results.
...
write_csv(merged_no_res, '../data/merged_tests_no_res.csv')
```
...
write_csv(merged_w_res, '../data/merged_tests_w_res.csv')
```
