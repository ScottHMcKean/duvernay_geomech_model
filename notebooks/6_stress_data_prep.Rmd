...
This notebook loads the raw stress data from Shen et al. (2018)'s publication, produced some figures for the paper, and outputs GeoJSON files for the geostatistics
workflow.
